      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs font-semibold text-slate-600">
            ...
            <button onClick={() => onSelectTab('admin')} className="hover:text-emerald-600 transition flex items-center space-x-1">
          ...
          <div className="flex items-center space-x-2 text-xs text-slate-400">
            <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-slate-100 text-slate-600 font-mono text-[10px]">
              Odoo Hackathon 2026
            </span>
            <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700 font-medium text-[10px]">
              Relational DB Ready
            </span>
          </div>
