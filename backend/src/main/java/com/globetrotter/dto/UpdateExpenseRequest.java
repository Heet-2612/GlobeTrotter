...
public class UpdateExpenseRequest {
    ...
    public UpdateExpenseRequest(String title, BigDecimal amount, String currency, ExpenseCategory category, LocalDate expenseDate, SplitType splitType, Long payerMemberId, List<ExpensePayerRequest> payers, Long tripActivityId, String notes, List<ExpenseParticipantRequest> participants) {
        this.title = title;
        this.amount = amount;
