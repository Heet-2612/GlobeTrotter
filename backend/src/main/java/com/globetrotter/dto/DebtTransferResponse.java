...
public class DebtTransferResponse {
    ...
    public DebtTransferResponse() {
    }

    public DebtTransferResponse(Long fromMemberId, String fromMemberName, Long toMemberId, String toMemberName, BigDecimal amount) {
