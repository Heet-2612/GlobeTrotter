        ...
        if (activityRepository.count() == 0) {
            ...
            if (goa != null) {
                activityRepository.saveAll(List.of(
                    ...
                    new Activity(null, goa, "Scuba Diving at Grande Island", "Underwater reef diving with experienced instructors.", "ADVENTURE", 240, 60.00, "USD", "https://images.unsplash.com/photo-1544551763-46a013bb70d5"),
                    new Activity(null, goa, "Mandovi River Sunset Cruise", "Evening catamaran cruise with live music and traditional dance.", "NIGHTLIFE", 90, 15.00, "USD", "https://images.unsplash.com/photo-1507525428034-b723cf961d3e")
                ));
            }
            ...
            if (mumbai != null) {
                activityRepository.saveAll(List.of(
                    ...
                    new Activity(null, mumbai, "Marine Drive Evening Promenade", "The Queen's Necklace C-shaped coastal boulevard.", "RELAXATION", 120, 0.00, "USD", "https://images.unsplash.com/photo-1570168007204-dfb528c6958f"),
                    new Activity(null, mumbai, "Elephanta Caves Ferry Tour", "UNESCO World Heritage rock-cut cave temples dedicated to Lord Shiva.", "CULTURE", 240, 12.00, "USD", "https://images.unsplash.com/photo-1570168007204-dfb528c6958f")
                ));
            }
            ...
            if (bangalore != null) {
                activityRepository.saveAll(List.of(
                    ...
                    new Activity(null, bangalore, "Lalbagh Botanical Garden Stroll", "240-acre botanical garden with glass house inspired by London Crystal Palace.", "RELAXATION", 150, 3.00, "USD", "https://images.unsplash.com/photo-1596176530529-78163a4f7af2")
                ));
            }

            if (paris != null) {
                activityRepository.saveAll(List.of(
                    new Activity(null, paris, "Eiffel Tower Summit Access", "Panoramic views of Paris from the 276-meter summit observation deck.", "SIGHTSEEING", 150, 30.00, "USD", "https://images.unsplash.com/photo-1502602898657-3e91760cbb34"),
                    new Activity(null, paris, "Louvre Museum Guided Tour", "Home of the Mona Lisa, Venus de Milo, and over 35,000 artworks.", "CULTURE", 180, 22.00, "USD", "https://images.unsplash.com/photo-1499856871958-5b9627545d1a")
                ));
            }

            if (rome != null) {
                activityRepository.saveAll(List.of(
                    new Activity(null, rome, "Colosseum & Roman Forum Priority Tour", "Flavian Amphitheatre historic tour of gladiator battle arenas.", "CULTURE", 180, 28.00, "USD", "https://images.unsplash.com/photo-1552832230-c0197dd311b5"),
                    new Activity(null, rome, "Trevi Fountain & Gelato Tasting", "Toss a coin into Rome's famous Baroque fountain and taste authentic gelato.", "FOOD", 90, 5.00, "USD", "https://images.unsplash.com/photo-1552832230-c0197dd311b5")
                ));
            }

            if (tokyo != null) {
                activityRepository.saveAll(List.of(
                    new Activity(null, tokyo, "Shibuya Crossing & Hachiko Statue", "World's busiest pedestrian scramble crossing.", "SIGHTSEEING", 60, 0.00, "USD", "https://images.unsplash.com/photo-1503899036084-c55cdd92da26"),
                    new Activity(null, tokyo, "Senso-ji Temple & Nakamise Shopping", "Tokyo's oldest Buddhist temple in historic Asakusa.", "CULTURE", 120, 0.00, "USD", "https://images.unsplash.com/photo-1503899036084-c55cdd92da26")
                ));
            }
        }
    }
