...
public class TripBudgetIntegrationTest {
    ...
    void test2_RetrieveBudgetSummary() throws Exception {
        mockMvc.perform(get("/api/trips/" + userATripId + "/budget")
                ...
                .andExpect(jsonPath("$.remainingBudget").value(500.00))
    ...
    void test3_UpdateTripBudget() throws Exception {
        ...
        mockMvc.perform(put("/api/trips/" + userATripId + "/budget")
                ...
                .andExpect(jsonPath("$.remainingBudget").value(750.00));
    }
    ...
    void test4_CalculateTotalActivityCostsDynamically() throws Exception {
        // Add Scuba Diving with customCost 55.00
        ...
        // Add Fort Aguada using default cost 10.00 (customCost = null)
        ...
        // Verify Total = 55.00 + 10.00 = 65.00
        mockMvc.perform(get("/api/trips/" + userATripId + "/budget")
                        .header("Authorization", "Bearer " + userAToken))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.totalActivityCost").value(65.00))
                .andExpect(jsonPath("$.remainingBudget").value(435.00))
    ...
    void test5_BudgetExceededFlagTriggers() throws Exception {
        ...
        mockMvc.perform(get("/api/trips/" + userATripId + "/budget")
                ...
                .andExpect(jsonPath("$.remainingBudget").value(-10.00))
    ...
    void test6_CategoryBreakdownCalculation() throws Exception {
        ...
        mockMvc.perform(get("/api/trips/" + userATripId + "/budget")
                ...
                .andExpect(jsonPath("$.categoryBreakdown[1].cost").value(10.00));
    }
